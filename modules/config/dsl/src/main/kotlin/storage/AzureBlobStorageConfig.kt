...
import org.noelware.hazel.configuration.kotlin.dsl.storage.azure.AzureAuthenticationHost
import org.noelware.hazel.configuration.kotlin.dsl.storage.azure.toAzureConnectionAuth
...
data class AzureBlobStorageConfig(
    ...
    fun toRemiConfig(): RemiAzureBlobStorageConfig = RemiAzureBlobStorageConfig(container, endpoint ?: "", auth.toAzureConnectionAuth())
}
