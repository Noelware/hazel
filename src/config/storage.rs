...
pub(crate) mod s3 {
    ...
    pub const DEFAULT_OBJECT_ACL: &str = "HAZEL_STORAGE_S3_DEFAULT_OBJECT_ACL";
    pub const DEFAULT_BUCKET_ACL: &str = "HAZEL_STORAGE_S3_DEFAULT_BUCKET_ACL";
    pub const SECRET_ACCESS_KEY: &str = "HAZEL_STORAGE_S3_SECRET_ACCESS_KEY";
    pub const ACCESS_KEY_ID: &str = "HAZEL_STORAGE_S3_ACCESS_KEY_ID";
    pub const APP_NAME: &str = "HAZEL_STORAGE_S3_APP_NAME";
    pub const ENDPOINT: &str = "HAZEL_STORAGE_S3_ENDPOINT";
    pub const PREFIX: &str = "HAZEL_STORAGE_S3_PREFIX";
    pub const REGION: &str = "HAZEL_STORAGE_S3_REGION";
    pub const BUCKET: &str = "HAZEL_STORAGE_S3_BUCKET";
...
pub(crate) mod azure {
    ...
    pub const SAS_TOKEN: &str = "HAZEL_STORAGE_AZURE_CREDENTIAL_SAS_TOKEN";
    pub const BEARER: &str = "HAZEL_STORAGE_AZURE_CREDENTIAL_BEARER";

    pub const ACCOUNT: &str = "HAZEL_STORAGE_AZURE_ACCOUNT";
    pub const URI: &str = "HAZEL_STORAGE_AZURE_URI";

    pub const CREDENTIAL: &str = "HAZEL_STORAGE_AZURE_CREDENTIAL";
    pub const CONTAINER: &str = "HAZEL_STORAGE_AZURE_CONTAINER";
    pub const LOCATION: &str = "HAZEL_STORAGE_AZURE_LOCATION";
