...
FROM --platform=$BUILDPLATFORM eclipse-temurin:17.0.6_10-jdk-jammy AS jdk-runtime
...
FROM --platform=$BUILDPLATFORM eclipse-temurin:17.0.6_10-jdk-jammy AS gradle-build
